...
type OrderRepository interface {
	...
	GetAllWithFiltersQuery(ctx context.Context, customerID int, deliveryStatuses string, sortBy string, fromDate *time.Time, toDate *time.Time, tx *sqlx.Tx) ([]entity.Order, error)
